    ...
    <div class="font-[sans-serif] mt-10">
        ...
        <div class="-mt-20 mb-6 px-4">
            <div class="mx-auto max-w-6xl shadow-lg p-8 relative bg-white rounded-lg">
                ...
                <form method="POST" action="{{route('product-create')}}" class="mt-8 space-y-3">
                    @csrf
                    <div>
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 rounded-lg text-sm tracking-wider font-medium border border-purple-700 outline-none bg-transparent hover:bg-purple-700 text-purple-700 hover:text-white transition-all duration-300">Add Product</button>
